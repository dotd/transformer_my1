...
from kaggle_implementation.src.transformer.transformer_encoder import TransformerEncoder
from kaggle_implementation.src.transformer.transformer_decoder import TransformerDecoder
